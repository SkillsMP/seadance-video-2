...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      ...
      title: 'Moderation',
      description: 'Custom content moderation provider settings',
      tab: 'ai',
    },
    {
      name: 'sightengine',
    ...
    },
    {
      name: 'wavespeed',
      title: 'Wavespeed',
      description: `Custom <a href="https://wavespeed.ai" class="text-primary" target="_blank">Wavespeed</a> moderation settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'switch',
      value: 'false',
      group: 'basic_moderation',
      tab: 'ai',
      tip: 'Review generation inputs and outputs before returning AI results',
    },
    {
      ...
      value: 'sightengine',
      options: [
        { title: 'Sightengine', value: 'sightengine' },
        { title: 'Wavespeed', value: 'wavespeed' },
      ],
      group: 'basic_moderation',
      tab: 'ai',
      tip: 'Choose the moderation provider to use',
    },
    {
      name: 'moderation_output_video_provider',
      title: 'Output Video Moderation Provider',
      type: 'select',
      value: '',
      options: [
        { title: 'Default Moderation Provider', value: '' },
        { title: 'Sightengine', value: 'sightengine' },
        { title: 'Wavespeed', value: 'wavespeed' },
      ],
      group: 'basic_moderation',
      tab: 'ai',
      tip: 'Choose a provider only for generated video output moderation',
    },
    {
      name: 'moderation_fail_closed',
      title: 'Moderation Fail Closed',
      type: 'switch',
      value: 'true',
      group: 'basic_moderation',
      tab: 'ai',
    ...
    {
      name: 'wavespeed_text_model',
      title: 'Wavespeed Text Model',
      type: 'text',
      value: 'wavespeed-ai/molmo2/text-content-moderator',
      placeholder: 'wavespeed-ai/molmo2/text-content-moderator',
      group: 'wavespeed',
      tab: 'ai',
    },
    {
      name: 'wavespeed_image_model',
      title: 'Wavespeed Image Model',
      type: 'text',
      value: 'wavespeed-ai/molmo2/image-content-moderator',
      placeholder: 'wavespeed-ai/molmo2/image-content-moderator',
      group: 'wavespeed',
      tab: 'ai',
    },
    {
      name: 'wavespeed_video_model',
      title: 'Wavespeed Video Model',
      type: 'text',
      value: 'wavespeed-ai/molmo2/video-content-moderator',
      placeholder: 'wavespeed-ai/molmo2/video-content-moderator',
      group: 'wavespeed',
      tab: 'ai',
    },
    {
      name: 'wavespeed_request_timeout_ms',
      title: 'Wavespeed Request Timeout MS',
      type: 'number',
      value: '30000',
      placeholder: '30000',
      group: 'wavespeed',
      tab: 'ai',
      tip: 'Maximum total time to wait for Wavespeed text and image moderation checks',
    },
    {
      name: 'wavespeed_poll_interval_ms',
      title: 'Wavespeed Poll Interval MS',
      type: 'number',
      value: '1000',
      placeholder: '1000',
      group: 'wavespeed',
      tab: 'ai',
      tip: 'Interval for polling Wavespeed prediction results',
    },
    {
      name: 'wavespeed_video_timeout_ms',
      title: 'Wavespeed Video Timeout MS',
      type: 'number',
      value: '120000',
      placeholder: '120000',
      group: 'wavespeed',
      tab: 'ai',
      tip: 'Maximum total time to wait for Wavespeed video moderation checks',
    },
    {
      name: 'wavespeed_video_poll_interval_ms',
      title: 'Wavespeed Video Poll Interval MS',
      type: 'number',
      value: '2000',
      placeholder: '2000',
      group: 'wavespeed',
      tab: 'ai',
      tip: 'Interval for polling Wavespeed video prediction results',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
