...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'sightengine',
      title: 'Sightengine',
      description: `Custom <a href="https://sightengine.com" class="text-primary" target="_blank">Sightengine</a> moderation settings`,
      tab: 'ai',
    },
    {
      name: 'adsense',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    {
      name: 'sightengine_moderation_enabled',
      title: 'Sightengine Moderation Enabled',
      type: 'switch',
      value: 'false',
      group: 'sightengine',
      tab: 'ai',
      tip: 'Review generation inputs before sending them to AI providers',
    },
    {
      name: 'sightengine_api_user',
      title: 'Sightengine API User',
      type: 'text',
      placeholder: '',
      group: 'sightengine',
      tab: 'ai',
    ...
    {
      name: 'sightengine_timeout_ms',
      title: 'Sightengine Timeout MS',
      type: 'number',
      value: '3500',
      placeholder: '3500',
      group: 'sightengine',
    ...
    },
    {
      ...
      group: 'sightengine',
      tab: 'ai',
      tip: 'Block generation if moderation is enabled but unavailable',
    },
    {
      name: 'adsense_code',
      title: 'Adsense Code',
