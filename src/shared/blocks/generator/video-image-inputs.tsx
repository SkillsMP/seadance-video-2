...
import type { VideoImageMode } from '@/config/ai/options';
...
export function VideoImageInputs({
  ...
  const [activeKind, setActiveKind] = useState<VideoImageInputKind>('frames');
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        {supportsReferenceImages && (
          <ToggleGroup
            ...
            onValueChange={(value) => {
              if (value) {
                setActiveKind(value as VideoImageInputKind);
              }
            }}
      ...
      <div className={cn('space-y-3', activeKind !== 'frames' && 'hidden')}>
        <div className={cn('grid gap-4', supportsEndFrame && 'sm:grid-cols-2')}>
          <div
        ...
        <p className="text-muted-foreground text-xs">{t('form.frames_hint')}</p>
      </div>
