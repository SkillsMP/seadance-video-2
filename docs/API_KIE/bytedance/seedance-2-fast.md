...
- **Type**: `array`
- **Required**: No
- **Description**: Please provide the URL of the uploaded file,A list of input video URLs. Furthermore, the total length of the three videos must not exceed 15 seconds. 
- **Max File Size**: 50MB
...
- **Type**: `array`
- **Required**: No
- **Description**: Please provide the URL of the uploaded file,A list of input audio URLs. Furthermore, the total length of the three audios must not exceed 15 seconds.
- **Max File Size**: 15MB
